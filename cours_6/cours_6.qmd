...
**Variantes** :\
- **STM (Structural Topic Model)** [@roberts2013structural] permet
d’incorporer des **covariables** (ex. date, genre, segment client).\
- **BERTopic** [@grootendorst2022bertopic] s’appuie sur les **embeddings
modernes** (BERT) et un clustering pour produire des thèmes plus
cohérents.\
- **Seeded LDA** : versions guidées où l’on fournit des mots-clés pour
orienter les thèmes.
:::
